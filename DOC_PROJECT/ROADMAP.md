...
- [ ] **M6-Bis — Stabilisation Demo/Live du GUI** : mode réel Live par défaut, mode Demo explicite avec stockage SQLCipher, connexion Google réelle, dashboard partagé et tests de stabilité avant M7. Le dataset/tutoriel Demo complet est reporté post-MVP.
