...
- [ ] **M6-Bis — Stabilisation Demo/Cloud du GUI** : choix explicite du mode, stockage local Demo SQLCipher, connexion Google réelle en mode Cloud, dashboard partagé et tests de stabilité avant M7.
